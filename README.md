![A luminous black hole bending a curved field of AI agent source code](assets/agent-banner.png)
...
I use AI tools to turn ideas into practical apps, utilities, and small experiments that make everyday tasks easier.

From automating repetitive work to building something just for fun, I enjoy exploring what I can create with AI and learning along the way.

![ChatGPT](https://img.shields.io/badge/ChatGPT-412991?style=for-the-badge&logo=openai&logoColor=white)
![Claude](https://img.shields.io/badge/Claude-D97757?style=for-the-badge&logo=claude&logoColor=white)
![Gemini](https://img.shields.io/badge/Gemini-8E75B2?style=for-the-badge&logo=googlegemini&logoColor=white)

> **Currently building** · Turning everyday needs and hobby ideas into small, useful tools with AI — from desktop utilities to web apps and Minecraft projects.

## 🛠️ Featured Projects

| Project | What it does | Platform |
| :--- | :--- | :--- |
| [**Cliplet · 拾片**](https://github.com/xgenya/cliplet) | A local-first clipboard manager with searchable history, quick paste, and on-device text recognition. | macOS |
| [**LiteTrack**](https://github.com/xgenya/litetrack) | Preview Minecraft schematics in 3D, organize material lists, and track collection progress with a team. | Web · Self-hosted |
| [**Command GUI**](https://github.com/xgenya/command-gui) | Manage Minecraft commands, fake players, and machine controls through a visual interface. | Minecraft · Fabric |
...
![Nuxt JS](https://img.shields.io/badge/Nuxt-002E3B?style=flat-square&logo=nuxt.js&logoColor=%2300DC82)
...
```rust
From: 07 April 2024 - To: 22 September 2026

Total Time: 3,558 hrs 32 mins

Vue.js                     1,931 hrs 23 mins     ##############-----------   54.27 %
Other                      323 hrs 9 mins        ##-----------------------   09.08 %
JavaScript                 305 hrs 17 mins       ##-----------------------   08.58 %
Java                       258 hrs 8 mins        ##-----------------------   07.25 %
Bash                       108 hrs 3 mins        #------------------------   03.04 %
TypeScript                 81 hrs 19 mins        #------------------------   02.29 %
Vue                        69 hrs 43 mins        -------------------------   01.96 %
C#                         51 hrs 44 mins        -------------------------   01.45 %
Markdown                   49 hrs 41 mins        -------------------------   01.40 %
C++                        44 hrs 24 mins        -------------------------   01.25 %
XML                        39 hrs 4 mins         -------------------------   01.10 %
CMake                      36 hrs 8 mins         -------------------------   01.02 %
Image (svg)                31 hrs 15 mins        -------------------------   00.88 %
```
...
Tried one of my tools? I'd love to hear what worked, what didn't, or what you'd like to see next. Open an issue in the project's repository, or [send me an email](mailto:i@remrin.dev).
